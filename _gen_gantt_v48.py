# -*- coding: utf-8 -*-
"""生成 LLM系統開發甘特圖_v4_8.xlsx
2026-05-04 更新：Phase 2 完成 101.4%、商機等級完成 100.2%、5/6專案完成
W1=4/01  W2=4/08  W3=4/15  W4=4/22  W5=4/29  W6=5/06（現在）  W7=5/13
...
DST = r"d:\yujui\痛點需求地圖\prompt定版\LLM系統開發甘特圖_v4_8.xlsx"

# ── 顏色 ──────────────────────────────────────────────────────────
C_DONE    = "EF4444"   # 完成紅
C_RUN     = "F59E0B"   # 執行中黃/橙
C_PLAN    = "93C5FD"   # 規劃藍
C_NOW     = "FF185F"   # 當前週粉紅（W6）
...
c = ws.cell(1, 1, "業務日誌 LLM 系統開發甘特圖  v4.8  (2026-05-04)")
...
note = ("v4.8 更新（2026-05-04）：Phase 2 完成（173,376筆，96.9%成功率）；"
        "商機等級完成（424萬筆）；5/6專案完成；Phase 3 待執行")
c = ws.cell(2, 1, note)
c.fill = fill("1E3A52")
...
# ── 資料 ──────────────────────────────────────────────────────────
# bars: list of (w_start, w_end_inclusive, status)
# status: "done" | "run" | "plan" | "now"
# W1=1  W2=2  W3=3  W4=4  W5=5  W6=6（當前週）  W7=7  W8=8  W9=9  W10=10  W11=11  W12=12  W13=13
...
ROWS = [
    ...
    ("商機等級 ✓", "LeadInfo 銷售漏斗（424萬筆 E/D/C2/C1/B/A）", "LLM",  "極低",
     [(4,6,"done")]),
    ...
    ("Phase 2 ✓",  "日報深度標籤（173,376筆，96.9%成功率）",      "LLM",  "$—",
     [(4,6,"done")]),
    (None, "  ✓ L1–L7 深度標籤（170,945家公司）",                "LLM",  "$—",
     [(4,6,"done")]),
    (None, "  ✓ 15 Workers，RPM=100，Gemini 2.5 Flash",          "LLM",  "$—",
     [(5,6,"done")]),
    (None, "  ✓ L 層覆蓋：L1=75.7% / L5=44.8% / L2=52.4%",      "LLM",  "$—",
     [(5,6,"done")]),
